...
SourceMapFileCollector.prototype = {
   ...
   */
  'addFileMapping': function (params) {
    ...
    // Reutrn this for a fluent interface
    return this;
  },
  toString: function () {
    var srcMapGenerator = this.srcMapGenerator;
...
function Collector(dest) {
  ...
  var fileCollector = new SourceMapFileCollector({'file': dest});
 ...
 * @param {String} [params.src] Alternative direct format for a single input
 * @param {String} [params.code] Alternative direct format for a single input
 * @return {Object} retObj
 * @return {String} retObj.code Minified JavaScript
 * @return {Object} retObj.sourcemap Sourcemap of input to minified JavaScript
 */
