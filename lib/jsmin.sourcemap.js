...
Collector.prototype = {
  ...
  'addFile': function (params) {
    ...
    if (lines) {
      ...
      // If there were no line breaks, insert a line break to prevent missing semicolon issues
      code = '\n' + code;
      ...
      //   codeMap[indices[i]] += 1;
      // }
      // TODO: Move back to for loop for optimization
      Object.getOwnPropertyNames(codeMap).forEach(function (key) {
        codeMap[key] += 1;
      });
      console.log(codeMap);
    }
