...
Collector.prototype = {
  ...
  'addFile': function (params) {
    ...
    if (lines) {
      ...
      // If there were no line breaks, force one at the top (for consistent behavior)
      // DEV: Otherwise, we would need to offset all of the mapping which can get tricky
