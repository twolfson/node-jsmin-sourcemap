...
console.log(params.output.charAt(destPoint), destLine, lineOffset);
      // Create our mapping
      var mapping = {
        'original': {
          'line': srcLine + 1,
...
Collector.prototype = {
  ...
  'addFile': function (params) {
    ...
    var lines = code.match(/\n/g),
        lineCount = 1;
    if (lines) {
      // TODO: This is probably the culprit... -_-
...
console.log('mmmmmmmmmmmmm', lineOffset, lineCount);
...
// console.log(collector.fileCollector.srcMapGenerator._mappings);
  // Retun the retObj
